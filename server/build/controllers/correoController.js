...
class CorreoController {
    ...
    static generatePdf(pdfDefinition) {
    ...
    envioCorreo(req, resp) {
        return __awaiter(this, void 0, void 0, function* () {
            let body = req.body;
            const lineasDescripcion = body.descripcion.split('\\n');
            const contenidoDescripcion = lineasDescripcion.map((linea) => {
                return {
                    text: linea,
                };
            });
            ...
            try {
                const pdfBuffer = yield CorreoController.generatePdf(pdfDefinition);
    ...
    envioCorreoAseguradora(req, resp) {
        return __awaiter(this, void 0, void 0, function* () {
            let body = req.body;
            const pdfDefinition = {
                content: [
    ...
    envioCorreoAseguradoraVida(req, resp) {
        return __awaiter(this, void 0, void 0, function* () {
            let body = req.body;
            const pdfDefinition = {
                content: [
